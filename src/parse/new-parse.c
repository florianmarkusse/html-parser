...
DocumentStatus updateReferencesNEW(const node_id newNodeID,
...
DocumentStatus parseNEW(const char *htmlString, Document *doc) {
    ...
    while (ch != '\0') {
        ...
        if (ch == '<') {
            ...
            // Comments or <!DOCTYPE>.
                ...
                // printing <!DOCTYPE is special case.
                    ...
                    if ((documentStatus = updateReferencesNEW(
        ...
        // Text node.
            ...
            if ((documentStatus = updateReferencesNEW(currentNodeID, prevNodeID,
                                                      &nodeStack, doc)) !=
                DOCUMENT_SUCCESS) {
                return documentStatus;
            }

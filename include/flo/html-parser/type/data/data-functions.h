...
flo_html_insertIntoSuitablePage(const flo_html_String data, size_t totalPages,
                                flo_html_ElementsContainer *container,
                                char **dataLocation);

flo_html_DataPageStatus
flo_html_insertIntoPageWithHash(const flo_html_String data, size_t totalPages,
